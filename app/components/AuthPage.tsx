...
export function AuthPage({mode}:{mode:"login"|"signup"}) {
 ...
 const signupContent=[
   ...
   <div className="unlock" key="unlock"><span>LEVEL 1</span><div className="unlock-ring">1</div><h1>Your journey<br/>is <em>ready.</em></h1><p>Career Awareness is unlocked. Your first mission is waiting.</p></div>
 ];
