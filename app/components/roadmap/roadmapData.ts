...
export const roadmapStats:
...

  {
    ...
    description:
      "Practical work for your portfolio",
  },

  {
    ...
    description:
      "Milestones that recognise progress",
  },

  {
    ...
    description:
      "Explore opportunities after readiness",
  },
];
...
export const roadmapCheckpoints:
  RoadmapCheckpoint[] = [
